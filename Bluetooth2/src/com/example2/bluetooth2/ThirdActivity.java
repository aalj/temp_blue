...
public class ThirdActivity extends Activity {
	...
	public void viewInit() {
		...
		tv_name.setText(getIntent().getStringExtra("Address"));
		...
		public BlueThread() {
			...
			try {
				bluetoothServerSocket = bt_adapter
						.listenUsingRfcommWithServiceRecord("Address",
								SecondActivity.MY_UUID);
			} catch (IOException e) {
	...
	public class Myonclick implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.btn_send:
				...
				// SecondActivity.connect(send);
				data(send);

				break;
			case R.id.shake:
				// SecondActivity.connect(shake);
				data(shake);
				break;
			case R.id.unshake:
				// SecondActivity.connect(unshake);
				data(unshake);
				break;
			case R.id.btn_lock:
				// SecondActivity.connect(lock);
				data(lock);
				break;
			case R.id.btn_unlock:
				// SecondActivity.connect(unlock);
				data(unlock);
				break;
			case R.id.btnclock:
				// SecondActivity.connect(time);
				data(time);
				break;
			default:
				break;
	...
	public void data(String data) {
		try {
			os = SecondActivity.client_Socket.getOutputStream();
		} catch (IOException e) {
