...
//		EditText etHide = (EditText) this.findViewById(R.id.etResult);
	...
	public void next(View view){
			...
			resulte = new NormalWay().topicWay(resulte,(TextView)this.findViewById(R.id.tvContent));
			clear();
			//让提交变得有效
			if(mark==false){
				mark = true;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView tvScore = (TextView) NormalActivity.this.findViewById(R.id.tvScoreContent);
	...
	public void mute(View view){
		...
		((MusicToggle)play).toggleM(ExitApplication.getInstance().getToggle(),NormalActivity.this,0x7f040004,
	...
	//检测返回事件
		...
		public void onBackPressed(){
		    ...
		    dataXml("1",scoreString);
			Intent intent = new Intent(NormalActivity.this,StartUi.class);
			...
			new AlertDialog.Builder(this).setTitle("系统提示")//设置对话框标题  
		     ...
		     .setPositiveButton("确定",new DialogInterface.OnClickListener() {//添加确定按钮  
		         ...
		         public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件  
		        	 ...
		        	 if(Integer.parseInt(getMaxScore("Normal"))<Integer.parseInt(scoreString)){
		        		 scoreXml("Normal",scoreString);
		        	 }
		        	 //关闭所有的activity
		        	 dataXml("1",scoreString);
