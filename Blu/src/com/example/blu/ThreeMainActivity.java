...
public class ThreeMainActivity extends Activity {
	...
	public void onclick(View v) {
		...
		case R.id.incomming:// 来电提醒
			...
			// 点击第二吃是关闭电话监听
			if (!call) {
				ThreeMainActivity.this.registerReceiver(inCallReceiver,
						intentFilter);
				button.setText("已打开");
				call = true;
			} else {
		...
		public BlueThread() {
			...
			try {
				...
				bluetoothServerSocket = bluetoothAdapter
						.listenUsingRfcommWithServiceRecord(Changliang.NAME,
								Changliang.MY_UUID);
			} catch (IOException e) {
	...
	private BroadcastReceiver receiver1 = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			String phoneData = ("电池技术 : " + technology + BatteryStatus
					+ BatteryTemp + "现在的电量是" + percent + "% 温度" + temperature);
	...
	public void myLock() {
		...
		mComponentName = new ComponentName(this,
				com.aalj35.aa11.Receiver.LockReceiver.class);
		// 判断是否有权限
