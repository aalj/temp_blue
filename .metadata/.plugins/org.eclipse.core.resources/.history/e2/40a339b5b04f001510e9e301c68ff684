...
//		if( (boolean) v.getTag()){
			...
			BluetoothFuntion.this.registerReceiver(receiver1, filter);//注册BroadcastReceiver
//			v.setTag(false);
//		}else {
//			//停止获取电池电量
//			
            ...
            dialog=new TimePickerDialog(
                    ...
                    new TimePickerDialog.OnTimeSetListener(){
                        public void onTimeSet(TimePicker timePicker, int hourOfDay,int minute) {
                            ...
                            Intent intent = new Intent(BluetoothFuntion.this,AlarmReceiver.class);    //创建Intent对象
                            intent.setAction("ELITOR_CLOCK");
//                            Intent intent = new Intent(BluetoothFuntion.this, AlarmReceiver.class);    //创建Intent对象
                            
                            PendingIntent pi = PendingIntent.getBroadcast(BluetoothFuntion.this,0, intent, PendingIntent.FLAG_UPDATE_CURRENT);    //创建PendingIntent
...
//                            alarmManager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis(), pi);        //设置闹钟，当前时间就唤醒
                            Toast.makeText(BluetoothFuntion.this, "闹钟设置成功", Toast.LENGTH_LONG).show();//提示用户
                        }
